...
from proxyip.Util.utilClass import Singleton
...
class DbClient(object):
    ...
    def __initDbClient(self):
        ...
        self.client = getattr(__import__(__type), __type)(name=conf.db_redis_name,
                                                          host=conf.db_redis_host,
                                                          port=conf.db_redis_port,
                                                          password=None)
